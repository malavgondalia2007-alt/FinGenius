...
export function EmotionalFeedback({
  ...
  return <Card className="p-0 overflow-hidden border-none shadow-lg transform hover:scale-[1.02] transition-transform duration-300" style={{
    backgroundColor: "#0d2aa0"
  }}>
