...
export function AgeStep({
  ...
  return <div className="max-w-md mx-auto animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Input type="number" label="Your Age" placeholder="e.g. 24" value={age} onChange={(e) => {
        setAge(e.target.value);
        setError('');
      }} error={error} autoFocus />

        {showAutoAssignMessage && <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3 animate-fade-in">
        ...
        {!isNaN(ageNum) && ageNum >= 18 && ageNum <= 100 && <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 flex items-start gap-3 animate-fade-in">
