...
export function TypeStep({
  ...
  return <div className="max-w-2xl mx-auto animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <button onClick={() => onNext('student')} className="flex flex-col items-center p-8 border-2 border-gray-200 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all group">
        ...
        <button onClick={() => onNext('employee')} className="flex flex-col items-center p-8 border-2 border-gray-200 rounded-xl hover:border-purple-500 hover:bg-purple-50 transition-all group">
