...
import { LayoutDashboard, CreditCard, Target, TrendingUp, Lightbulb } from 'lucide-react';
...
export function WelcomeStep({
  ...
  return <div className="text-center animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left mb-8">
        {features.map((feature, idx) => <div key={idx} className="flex items-start p-4 border border-gray-100 rounded-xl hover:shadow-md transition-shadow bg-white">
