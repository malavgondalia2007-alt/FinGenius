...
export function FinancialReport({
  ...
  return <div className="fixed inset-0 bg-charcoal/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
        ...
        <div className="bg-charcoal p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex justify-between items-start">
            <div>
              ...
              <p className="opacity-80 text-lg font-sans">
                {report.month} {report.year}
              </p>
            </div>
            <div className="text-right">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 mb-2">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
              <p className="text-xs text-charcoal-500 uppercase tracking-wider mb-1 font-bold">
                Income
              </p>
            ...
            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
              ...
              <p className={`text-lg font-bold ${report.savingsRate >= 20 ? 'text-sage-600' : 'text-amber-600'}`}>
          ...
          {/* Insights */}
          <div>
            <h3 className="text-lg font-bold text-charcoal mb-4 flex items-center gap-2 font-serif">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-gray-200 rounded-xl p-5">
              <div className="flex items-center gap-2 mb-3 text-charcoal-500">
