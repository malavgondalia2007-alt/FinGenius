...
export function AutoSplitModal({
  onConfirm,
  onDecline
}: AutoSplitModalProps) {
  ...
  return <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
      <Card className="max-w-md w-full p-6 relative">
        ...
        <div className="mb-8">
          ...
          <div className="px-4">
            <input type="range" min="0" max="50" step="5" value={percentage} onChange={(e) => setPercentage(parseInt(e.target.value))} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-emerald-600" />
        ...
        <div className="flex gap-3">
          ...
          <Button variant="emerald" onClick={() => onConfirm(percentage)} className="flex-1">
            Enable Auto-Split
          </Button>
        </div>
      </Card>
