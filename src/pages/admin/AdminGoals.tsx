...
export function AdminGoals() {
  ...
  return <AdminLayout>
      <div className="space-y-6">
        ...
        {/* Goals Grid */}
        {goalsWithDetails.length === 0 ? <div className="bg-white rounded-xl border border-slate-200 p-16 text-center">
            ...
            {goalsWithDetails.map((goal) => <div key={goal.id} className="bg-white rounded-xl border border-slate-200 p-6 hover:border-slate-300 transition-colors">
                {/* Goal Header */}
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-slate-100 rounded-full h-2.5 overflow-hidden">
                    <div className="bg-gradient-to-r from-purple-600 to-purple-500 h-2.5 rounded-full transition-all duration-500" style={{
