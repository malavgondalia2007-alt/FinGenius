...
export function AdminUsers() {
  ...
  const deleteUser = (userId: string, userName: string) => {
    ...
    if (confirmed) {
      ...
      const updatedUsers = db.users.getAll();
  ...
  },
  {
    ...
    render: (_: any, user: User) =>
    <button
      className="w-10 h-10 flex items-center justify-center rounded-xl border-2 border-slate-200 bg-white hover:bg-red-50 hover:border-red-300 transition-all duration-200 group"
