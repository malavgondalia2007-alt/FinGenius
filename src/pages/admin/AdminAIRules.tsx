...
import { Cpu, Zap, Sliders, AlertTriangle, CheckCircle, ArrowRight } from 'lucide-react';
export function AdminAIRules() {
  const insights = [{
    id: 1,
    type: 'Spending Anomaly',
    message: 'Unusual spike in "Entertainment" category across 15% of users this weekend.',
    ...
    message: 'Users with >40% income in rent are failing "Emergency Fund" goals at 2x rate.',
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-slate-100">
            {insights.map((insight) => <div key={insight.id} className="p-6 hover:bg-slate-50 transition-colors">
