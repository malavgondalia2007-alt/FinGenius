...
import { ArrowRight, RefreshCw, TrendingUp, Wallet, Calculator, HelpCircle, ChevronDown, ChevronUp, Lightbulb, DollarSign, ShoppingCart, Zap } from 'lucide-react';
export function ScenarioPlanning() {
  ...
  const calculateImpact = () => {
    if (!profile) return;
    // Base values
    let currentIncome = profile.type === 'student' ? (profile.weeklyPocketMoney || 0) * 4 : profile.monthlyIncome || 0;
    let currentFixedExpenses = profile.type === 'student' ? (profile.weeklyExpenses || 0) * 4 : Object.values(profile.fixedExpenses || {}).reduce((a, b) => a + b, 0);
    ...
    const totalCurrentExpenses = currentFixedExpenses + estimatedVariableExpenses;
    ...
    const newMonthlyExpense = parseFloat(scenario.newMonthlyExpense.toString() || '0');
    ...
    const oneTimeRecoveryMonths = newSavings > 0 ? oneTimeExpense / newSavings : Infinity;
    setResult({
      currentIncome,
  ...
  return <div className="w-full">
      ...
      <Card className="mb-8 overflow-hidden">
        <button onClick={() => setShowHelp(!showHelp)} className="w-full p-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-blue-100 rounded-lg">
              <HelpCircle className="w-5 h-5 text-blue-600" />
            </div>
            <div className="text-left">
              <h3 className="font-bold text-gray-900">How to Use This Tool</h3>
        ...
        {showHelp && <div className="px-6 pb-6 pt-2 border-t border-gray-100 animate-fade-in">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-800">
                      Test "what-if" scenarios before they happen. See how life
                      changes—like a raise, new subscription, or emergency
                      expense—will affect your monthly savings and financial
                      goals.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">
                        Click "Simulate Impact" to see how these changes affect
                        your monthly savings and how long it will take to
                        recover from one-time expenses.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input type="number" placeholder="e.g. 5000 or -2000" value={scenario.incomeChange} onChange={(e) => setScenario({
                ...scenario,
              ...
              <div>
                ...
                <Input type="number" placeholder="e.g. 2000" value={scenario.newMonthlyExpense} onChange={(e) => setScenario({
                ...scenario,
              ...
              <div>
                ...
                <Input type="number" placeholder="e.g. 50000" value={scenario.oneTimeExpense} onChange={(e) => setScenario({
                ...scenario,
        ...
        <div className="lg:col-span-2">
          {result ? <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Card className={`p-6 bg-white border-l-4 ${result.newSavings >= result.currentSavings ? 'border-green-500' : 'border-red-500'}`}>
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">
                    Projected Status
                  </p>
                  <div className="space-y-1">
                    ...
                    <div className="pt-2 border-t border-gray-100 flex justify-between">
                      <span className="font-bold text-gray-900">Savings:</span>
                      <span className={`font-bold ${result.newSavings >= result.currentSavings ? 'text-green-600' : 'text-red-600'}`}>
              ...
              <Card className="p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className={`p-2 rounded-lg ${result.newSavings > 0 ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'}`}>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {result.newSavings > 0 ? `You will save ₹${result.newSavings.toLocaleString()} per month.` : 'Warning: Your expenses will exceed your income.'}{' '}
                        {result.difference !== 0 && <span className={result.difference > 0 ? 'text-green-600' : 'text-red-600'}>
                  ...
                  {result.oneTimeExpense > 0 && <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        {result.newSavings > 0 ? <p className="text-sm font-bold text-purple-700 mt-1">
                            It will take {Math.ceil(result.oneTimeRecovery)}{' '}
                            months of savings.
                          </p> : <p className="text-sm font-bold text-red-600 mt-1">
            ...
            </div> : <div className="h-full flex flex-col items-center justify-center text-gray-400 border-2 border-dashed border-gray-200 rounded-2xl p-12">
